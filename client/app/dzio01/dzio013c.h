...
#endif
/***************************************************************************
* Definition for Record Group.DZIO013R
***************************************************************************/
...
#define   ELMID_LEN                             9
#endif
#ifndef _DZIO013RQST_z
#define _DZIO013RQST_z

typedef struct __DZIO013Rqst
{
   char                  Vw_Nm[19];
   char                  ElmTblNm[19];
   char                  ElmId[9];
...
#endif
/***************************************************************************
* Definition for Record.DZIO013C
***************************************************************************/
#ifndef _WCDDZIO013C_z
#define _WCDDZIO013C_z

typedef struct __WCDDzio013c
{
   _ARCHDATA             ArchData;
   _ENTITYDATA           EntityData;
   _REQUESTHDR           RequestHdr;
   _REPLYHDR             ReplyHdr;
   _DZIO013RQST          DZIO013Rqst;
}  _WCDDZIO013C;
#endif
...
#define  WCD_DZIO013Rqst       pWindContextData->DZIO013Rqst
#define  WINCONTEXTNAME        _WCDDZIO013C
