 ...
 ***************************************************************************
 *                                                                         *
 *                      Module File for: AZDW001                           *
 *                         Generated on: Wed Nov  3 14:43:27 1993          *
 *                                   by: CCRAMPTO                          *
 *                                                                         *
 ***************************************************************************
 * You may need to                                                         *
...
#define WINDOWNAME AZDW001
#define INCL_WIN
#define WINDOWMOD
#define INCL_DOS           /* CSC: Handedit 08/12/93 */
#define INCL_DOSERRORS     /* CSC: Handedit 08/12/93 */
#define INCL_DOSSEMAPHORES /* CSC: Handedit */
...
#define WESMAPNAME _AZDW001WesMap
#include "azdw001.wmp"
